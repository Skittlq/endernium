...
public class EnderniumShovel extends ShovelItem {
    ...
    public EnderniumShovel(Tier tier, float attackDamageModifier, float attackSpeedModifier, Properties properties) {
